...
/*   Updated: 2020/09/02 17:45:50 by pfelipa          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					ft_process_body(char *buff, char *symbols,
					int *size, char ***map);
int					ft_process_header(char *buff, char *symbols,
					int *size, int len);
...
int					check_square(t_list *map_item, int size,
					struct s_coords start);
void				answer_map(t_list *map_item, int size,
					struct s_coords start);
